...
def load_simulation_data(experiment_name=None, experiment_date=None):
    ...
    if main_configs_dir.exists():
        config_files.update(main_configs_dir.glob("*.json"))
    ...
    if experiment_name and experiment_date:
        ...
        if exp_subdir.exists():
            ...
            if exp_configs_dir.exists():
                config_files.update(exp_configs_dir.glob("*.json"))
        ...
        for subdir in results_dir.iterdir():
            if subdir.is_dir():
                ...
                if exp_configs_dir.exists():
                    ...
                    if matching_files:
                        config_files.update(matching_files)
...
def create_agent_ratio_analysis(experiment_name=None, experiment_date=None):
    ...
    ax1.set_title('Accomplished Goals vs GoalFirst/Monitoring Ratio', fontsize=12, fontweight='bold')
    ...
    ax2.set_title('Remaining Goals vs GoalFirst/Monitoring Ratio', fontsize=12, fontweight='bold')
    ...
    ax3.set_title('Consent Violation Ratio vs GoalFirst/Monitoring Ratio', fontsize=12, fontweight='bold')
    ...
    ax4.set_title('Resource Conflicts vs GoalFirst/Monitoring Ratio', fontsize=12, fontweight='bold')
    ...
    ax5.set_title('Counter Goal Accomplishments vs GoalFirst/Monitoring Ratio', fontsize=12, fontweight='bold')
    ...
    # Set title
    ax6_steps.set_title('Average Steps & Accomplished Goals vs GoalFirst/Monitoring Ratio', fontsize=12, fontweight='bold')
...
def create_agent_level_analysis(experiment_name=None, experiment_date=None):
    ...
    ax_r1.errorbar(df_agent_summary['goal_first_count'], df_agent_summary['avg_violated_consents_goal_first_r'], 
                   ...
                   fmt='o-', linewidth=2, markersize=6, capsize=4, label='Goal-First Agent (R)', color='blue')
    ax_r1.errorbar(df_agent_summary['goal_first_count'], df_agent_summary['avg_violated_consents_monitoring_r'], 
                   yerr=df_agent_summary['avg_violated_consents_monitoring_r_sem'], 
                   fmt='s-', linewidth=2, markersize=6, capsize=4, label='Monitoring Agent (R)', color='red')
    ...
    ax_r2.errorbar(df_agent_summary['goal_first_count'], df_agent_summary['avg_total_consents_goal_first_r'], 
                   ...
                   fmt='o-', linewidth=2, markersize=6, capsize=4, label='Goal-First Agent (R)', color='blue')
    ax_r2.errorbar(df_agent_summary['goal_first_count'], df_agent_summary['avg_total_consents_monitoring_r'], 
    ...
    ax_r3.errorbar(df_agent_summary['goal_first_count'], df_agent_summary['avg_consent_violation_ratio_goal_first_r'], 
                   ...
                   fmt='o-', linewidth=2, markersize=6, capsize=4, label='Goal-First Agent (R)', color='blue')
    ax_r3.errorbar(df_agent_summary['goal_first_count'], df_agent_summary['avg_consent_violation_ratio_monitoring_r'], 
    ...
    ax_r4.errorbar(df_agent_summary['goal_first_count'], df_agent_summary['avg_consent_fulfillment_ratio_goal_first_r'], 
                   ...
                   fmt='o-', linewidth=2, markersize=6, capsize=4, label='Goal-First Agent (R)', color='blue')
    ax_r4.errorbar(df_agent_summary['goal_first_count'], df_agent_summary['avg_consent_fulfillment_ratio_monitoring_r'], 
    ...
    ax_g1.errorbar(df_agent_summary['goal_first_count'], df_agent_summary['avg_violated_consents_goal_first_g'], 
                   ...
                   fmt='o-', linewidth=2, markersize=6, capsize=4, label='Goal-First Agent (G)', color='blue')
    ax_g1.errorbar(df_agent_summary['goal_first_count'], df_agent_summary['avg_violated_consents_monitoring_g'], 
                   yerr=df_agent_summary['avg_violated_consents_monitoring_g_sem'], 
                   fmt='s-', linewidth=2, markersize=6, capsize=4, label='Monitoring Agent (G)', color='red')
    ...
    ax_g2.errorbar(df_agent_summary['goal_first_count'], df_agent_summary['avg_total_consents_goal_first_g'], 
                   ...
                   fmt='o-', linewidth=2, markersize=6, capsize=4, label='Goal-First Agent (G)', color='blue')
    ax_g2.errorbar(df_agent_summary['goal_first_count'], df_agent_summary['avg_total_consents_monitoring_g'], 
    ...
    ax_g3.errorbar(df_agent_summary['goal_first_count'], df_agent_summary['avg_consent_violation_ratio_goal_first_g'], 
                   ...
                   fmt='o-', linewidth=2, markersize=6, capsize=4, label='Goal-First Agent (G)', color='blue')
    ax_g3.errorbar(df_agent_summary['goal_first_count'], df_agent_summary['avg_consent_violation_ratio_monitoring_g'], 
    ...
    ax_g4.errorbar(df_agent_summary['goal_first_count'], df_agent_summary['avg_consent_fulfillment_ratio_goal_first_g'], 
                   ...
                   fmt='o-', linewidth=2, markersize=6, capsize=4, label='Goal-First Agent (G)', color='blue')
    ax_g4.errorbar(df_agent_summary['goal_first_count'], df_agent_summary['avg_consent_fulfillment_ratio_monitoring_g'], 
    ...
    ax_gen1.errorbar(df_agent_summary['goal_first_count'], df_agent_summary['avg_accomplished_goals_goal_first_agent'], 
                     ...
                     fmt='o-', linewidth=2, markersize=6, capsize=4, label='Goal-First Agent', color='blue')
    ax_gen1.errorbar(df_agent_summary['goal_first_count'], df_agent_summary['avg_accomplished_goals_monitoring_agent'], 
                     yerr=df_agent_summary['avg_accomplished_goals_monitoring_agent_sem'], 
                     fmt='s-', linewidth=2, markersize=6, capsize=4, label='Monitoring Agent', color='red')
    ...
    ax_gen2.errorbar(df_agent_summary['goal_first_count'], df_agent_summary['avg_remaining_goals_goal_first_agent'], 
                     ...
                     fmt='o-', linewidth=2, markersize=6, capsize=4, label='Goal-First Agent', color='blue')
    ax_gen2.errorbar(df_agent_summary['goal_first_count'], df_agent_summary['avg_remaining_goals_monitoring_agent'], 
    ...
    ax_gen3.errorbar(df_agent_summary['goal_first_count'], df_agent_summary['avg_resource_conflicts_goal_first_agent'], 
                     ...
                     fmt='o-', linewidth=2, markersize=6, capsize=4, label='Goal-First Agent', color='blue')
    ax_gen3.errorbar(df_agent_summary['goal_first_count'], df_agent_summary['avg_resource_conflicts_monitoring_agent'], 
    ...
    ax_gen4.errorbar(df_agent_summary['goal_first_count'], df_agent_summary['avg_counter_goal_accomplishments_goal_first_agent'], 
                     ...
                     fmt='o-', linewidth=2, markersize=6, capsize=4, label='Goal-First Agent', color='blue')
    ax_gen4.errorbar(df_agent_summary['goal_first_count'], df_agent_summary['avg_counter_goal_accomplishments_monitoring_agent'], 
    ...
    ax_int1.errorbar(df_interaction_summary['goal_first_count'], df_interaction_summary['avg_finished_step_goal_first_agent'], 
                     ...
                     fmt='o-', linewidth=2, markersize=6, capsize=4, label='Goal-First Agent', color='blue')
    ax_int1.errorbar(df_interaction_summary['goal_first_count'], df_interaction_summary['avg_finished_step_monitoring_agent'], 
    ...
    ax_int2.errorbar(df_interaction_summary['goal_first_count'], df_interaction_summary['avg_longest_idle_time_goal_first_agent'], 
                     ...
                     fmt='o-', linewidth=2, markersize=6, capsize=4, label='Goal-First Agent', color='blue')
    ax_int2.errorbar(df_interaction_summary['goal_first_count'], df_interaction_summary['avg_longest_idle_time_monitoring_agent'], 
    ...
    ax_int3.errorbar(df_interaction_summary['goal_first_count'], df_interaction_summary['avg_distinct_agents_interacted_r_goal_first_agent'], 
                     ...
                     fmt='o-', linewidth=2, markersize=6, capsize=4, label='Goal-First Agent (R)', color='blue')
    ax_int3.errorbar(df_interaction_summary['goal_first_count'], df_interaction_summary['avg_distinct_agents_interacted_r_monitoring_agent'], 
    ...
    ax_int4.errorbar(df_interaction_summary['goal_first_count'], df_interaction_summary['avg_distinct_agents_interacted_g_goal_first_agent'], 
                     ...
                     fmt='o-', linewidth=2, markersize=6, capsize=4, label='Goal-First Agent (G)', color='blue')
    ax_int4.errorbar(df_interaction_summary['goal_first_count'], df_interaction_summary['avg_distinct_agents_interacted_g_monitoring_agent'], 
